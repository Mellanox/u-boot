...
STATIC_PREFIX datum   memTestDataBus(datum *address);
STATIC_PREFIX datum *memTestAddressBus(datum *baseAddress,\
	unsigned long nBytes);
STATIC_PREFIX datum *memTestDevice(datum *baseAddress, unsigned long nBytes);

#ifndef CONFIG_AML_UBOOT_MAGIC
#define CONFIG_AML_UBOOT_MAGIC 0x12345678
#endif

static unsigned ddr_start_again;
...
static unsigned *sw_train = (unsigned *)0x4901fff0;
