...
void dcache_flush(void)
{
	...
	if (dcache_status()) {
		...
		/* also flush the locked lines */
		_sr(_lr(ARC_REG_DC_CTRL) | ARC_REG_DC_CTRL_LM | \
			ARC_REG_DC_CTRL_IM, ARC_REG_DC_CTRL);
...
{
#ifndef CONFIG_SYS_NO_DCACHE
	return (_lr(ARC_REG_DC_CTRL) & ARC_REG_DC_CTRL_DIS) != \
		ARC_REG_DC_CTRL_DIS;
#else
	return 0;
#endif
...
{
#ifndef CONFIG_SYS_NO_ICACHE
	return (_lr(ARC_REG_IC_CTRL) & ARC_REG_IC_CTRL_DC) != \
		ARC_REG_IC_CTRL_DC;
#else
	return 0;
#endif
